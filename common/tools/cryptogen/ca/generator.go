...
// baseDir/name
func NewCA(baseDir, org, name, country, province, locality, orgUnit, streetAddress, postalCode, defaultBccsp string) (*CA, error) {
	...
	if err == nil {
		priv, signer, err := csp.GeneratePrivateKey(baseDir, defaultBccsp)
		response = err
		if err == nil {
